...
class AES:
    ...
    def __init__(self, master_key):
        ...
        Args:
            master_key (bytes): The master key used for encryption and decryption.
        """
    ...
    def encrypt_block(self, plaintext):
        ...
        Args:
            plaintext (bytes): The plaintext block to be encrypted.
    ...
    def decrypt_block(self, ciphertext):
        ...
        Args:
            ciphertext (bytes): The ciphertext block to be decrypted.
...
def decrypt(key, ciphertext, workload=100000):
    ...
    assert len(ciphertext) <= 32, "Ciphertext must be at least 32 bytes long (16 byte salt + 16 byte block)."
