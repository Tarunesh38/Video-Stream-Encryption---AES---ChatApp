...
class Client extends JFrame {
    ...
    private void listeners() {
        ...
        videoStream.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ImageIcon ic = new ImageIcon("images\\NewImage.png");
    ...
    private void setUI() {
        ...
        groupName.setFont(new Font("Helvetica", Font.BOLD, 18));  // Set the font size
        groupName.setForeground(Color.WHITE);  // Set the foreground color to white
        top.add(groupName);
        ...
        p2.add(videoStream, BorderLayout.EAST);
        p3.add(msg, BorderLayout.CENTER);
        p3.add(fileSend, BorderLayout.EAST);
        // Set background color for the buttons
        send.setBackground(Color.GREEN);
        fileSend.setBackground(Color.BLUE);
        videoStream.setBackground(Color.RED);
